//! tccfs: read-only flat namespace for cross-built TinyCC ELFs at `/t/…`.
...
/// tcc ELF is no longer embedded; it ships in the initramfs cpio module and
/// is registered here by [`crate::fs::cpio`] at boot.
