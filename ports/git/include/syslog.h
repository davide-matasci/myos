/* Minimal syslog stubs for freestanding myos (git Phase 1). */
#ifndef _MYOS_SYSLOG_H_
#define _MYOS_SYSLOG_H_
...
static inline void vsyslog(int priority, const char *format, __builtin_va_list ap) {
    (void)priority; (void)format; (void)ap;
}

#endif /* _MYOS_SYSLOG_H_ */
