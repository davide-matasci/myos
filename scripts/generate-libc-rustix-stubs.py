#!/usr/bin/env python3
"""Generate patches/coreutils/libc/rustix_compat.rs from upstream libc Linux defs."""
...
OUT = ROOT / "patches/coreutils/libc/rustix_compat.rs"
...
def main() -> int:
    ...
    lines = [
        "// Auto-generated by scripts/generate-libc-rustix-stubs.py — compile-time rustix groundwork.",
