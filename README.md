...
**stdin** merges keyboard and serial. Keyboard characters come from a **loadable keymap** (default Swiss German via `user/init` → `/etc/kbd/ch.map`; see `docs/keymap.md`). Serial always available and does not need a map.
